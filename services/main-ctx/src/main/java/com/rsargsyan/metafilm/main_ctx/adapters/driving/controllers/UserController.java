...
import com.rsargsyan.metafilm.main_ctx.core.app.dto.ApiKeyCreationDTO;
...
public class UserController {
  ...
  public ResponseEntity<ApiKeyDTO> createApiKey(@PathVariable String userId,
    ...
    String actingUserProfileId = UserContextHolder.get().getUserProfileId();
    return new ResponseEntity<>(userService.createApiKey(actingUserProfileId, userId, req.description()), HttpStatus.CREATED);
  }
